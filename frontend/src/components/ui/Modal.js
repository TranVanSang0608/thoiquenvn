      ...
      >
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="fixed inset-0 bg-neutral-dark bg-opacity-50 transition-opacity" />
          </Transition.Child>
            ...
            <div className={`inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle ${sizeClasses[size]} w-full`}>
              <div className="bg-white p-6">
                <div className="flex items-start justify-between">
                  <Dialog.Title as="h3" className="text-lg font-medium text-neutral-dark">
                    {title}
                  </Dialog.Title>
